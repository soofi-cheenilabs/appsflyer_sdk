...
public class AppsflyerSdkPlugin implements MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        switch (method) {
            ...
            case "getAppsFlyerUID":
                callGetAppsFlyerUID(call, result);
                break;
            case "setHost":
                setHost(call, result);
                break;
    ...
    // following method is added to get the appsflyer uid
    private void callGetAppsFlyerUID(MethodCall call, MethodChannel.Result result) {
        AppsFlyerLib instance = AppsFlyerLib.getInstance();
        final String appsFlyerUID = instance.getAppsFlyerUID(mContext);
        System.out.println("appsFlyerUID: " + appsFlyerUID);
